...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str,
                        default="/home/algroup/lsw/RPVM/RPVM/llama3-8b-instruct",
                        help="Path to Llama3 model")
    parser.add_argument("--dataset_path", type=str,
                        default="/home/algroup/lsw/RPVM/RPVM/datasets/2wikimultihopqa/train.jsonl",
                        help="Path to dataset")
    parser.add_argument("--prompt_path", type=str,
                        default="/home/algroup/lsw/RPVM/RPVM/experiments/plan_evaluation/prompts/planner_global.md",
                        help="Path to prompt template")
    parser.add_argument("--output_dir", type=str,
                        default="/home/algroup/lsw/RPVM/RPVM/experiments/plan_evaluation/outputs/llama3_8b_global_plan",
